...
sudo ovs-vsctl add-port br-mgmt vxlan-c1 -- set interface vxlan-c1 type=vxlan options:remote_ip=159.203.255.221 options:local_ip=45.55.25.244 options:key=100
